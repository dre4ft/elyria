...
function renderProfileList() {
  ...
  state.profiles.forEach(p => {
    ...
    const redIcon = isPentest ? '<span class="flex-shrink-0 w-4 h-4 rounded-full bg-red-500/10 border border-red-500/20 flex items-center justify-center" title="Analyse de remediation — importe depuis Red Team"><svg class="w-2.5 h-2.5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z"/></svg></span>' : '';
